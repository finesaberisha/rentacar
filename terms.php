...
<main class="explore-cars-page">
    <section class="section featured-car" id="featured-car">
        <div class="container">
          ...
          <div class="title-wrapper">
            <h2 class="h2 section-title">Terms & Conditions</h2>
    ...
    <br>
    <h2 class="h2 section-title">Confirming your booking and taking payment</h2>
